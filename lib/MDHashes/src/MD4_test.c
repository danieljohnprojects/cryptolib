...
void test_MD4digest()
{
    ...
    MD4digest(message, 0, digest);
    print_digest(digest);
    assert (digest[0] == 0x31);
    assert (digest[1] == 0xd6);
    printf("\n");
    ...
    for (size_t i = 0; i < DIGEST_LENGTH; i++)
        digest[i] = 0x00;
    message[0] = 'a';
    MD4digest(message, 1, digest);
    print_digest(digest);
    assert (digest[0] == 0xbd);
    assert (digest[1] == 0xe5);
    printf("\n");
    ...
    MD4digest(message, strlen((char *) message), digest);
    print_digest(digest);
    assert (digest[0] == 0xa4);
    assert (digest[1] == 0x48);
    printf("\n");
    ...
    MD4digest(message, strlen((char *) message), digest);
    print_digest(digest);
    assert (digest[0] == 0xd9);
    assert (digest[1] == 0x13);
    printf("\n");
    ...
    MD4digest(message, strlen((char *) message), digest);
    print_digest(digest);
    assert (digest[0] == 0xd7);
    assert (digest[1] == 0x9e);
    printf("\n");
    ...
    MD4digest(message, strlen((char *) message), digest);
    print_digest(digest);
    assert (digest[0] == 0x04);
    assert (digest[1] == 0x3f);
    printf("\n");
    ...
    MD4digest(message, strlen((char *) message), digest);
    print_digest(digest);
    assert (digest[0] == 0xe3);
    assert (digest[1] == 0x3b);
    printf("\n");
}
